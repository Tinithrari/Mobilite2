 ...
 * A sheep
 */
public class Sheep extends ParticlePhysics{
    ...
    private void changeDir() {
        ...
        if (direction.x == -1)
            this.animator.setAnimation(AnimationStore.get().getAnimation(ResourceLoader.WHITE_SHEEP_LEFT));
        else if (direction.x == 1)
            this.animator.setAnimation(AnimationStore.get().getAnimation(ResourceLoader.WHITE_SHEEP_RIGHT));
        else if (direction.y == -1)
            this.animator.setAnimation(AnimationStore.get().getAnimation(ResourceLoader.WHITE_SHEEP_DOWN));
        else
            this.animator.setAnimation(AnimationStore.get().getAnimation(ResourceLoader.WHITE_SHEEP_UP));
    }
     ...
     */
    public Sheep(Vector2 position, float mass, Vector2 size) {
        super(position, mass);
        animator = new Animator(83.3f, true, AnimationStore.get().getAnimation(ResourceLoader.WHITE_SHEEP_DOWN));
        changeDir();
